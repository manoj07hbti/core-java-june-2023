...
public class EmployeeHashSet {
    ...
    public HashSet<Employee> createEmployeeSet() {
        ...
        Employee employee1 = new Employee("JAYDEEP", 40, 5, "IT", 45600);
        System.out.println("Hashcode of Employee 1 is:" + employee1.hashCode());
        Employee employee2 = new Employee("NEERAJ", 39, 6, "SALES", 47600);
        ...
        Employee employee11 = new Employee("JAYDEEP", 40, 5, "IT", 45600);
        System.out.println("Hashcode of Employee 11 is:" + employee11.hashCode());
        Employee employee12 = new Employee("NEERAJ", 39, 6, "SALES", 47600);
